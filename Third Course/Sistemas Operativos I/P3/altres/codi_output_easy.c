...
void funcio_presoner_generica(int presoner, int estrategia_presoner, int n, int fdFillToPare[2], int fdPareToFill[2]);
...
int main(int argc, char *argv[])
{
    ...
    if (presoner1 == 0)
    {
        funcio_presoner_generica(presoner1, estrategia_pr1, N, fdFillToPare, fdPareToFill);
    }
    else
    {
        int presoner2 = fork();
        if (presoner2 == 0)
        {
            funcio_presoner_generica(presoner2, estrategia_pr2, N, fdFillToPare, fdPareToFill);
        }
        else
        {
