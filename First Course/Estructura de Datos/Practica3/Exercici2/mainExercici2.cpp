...
float preuQueries(Inventari<BSTArbre<string, FoodPackage>> *inventari);
int main()
{
    int opcio;
    ...
    Inventari<BSTArbre<string, FoodPackage>> *inventari = new Inventari<BSTArbre<string, FoodPackage>>(0.21);
    do
    {
        try
        {
